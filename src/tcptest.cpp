...
//                {"OPEN=", "CNTLON", "LOAD=ROS", "EDATA1 *ROS", "OVRD=5",
//                 "EDATA2 J1=(0,0,0,0,0,0,0,0)", //....
//                 "EDATAX IF M_SVO<>1 THEN GOTO *ROS",
//                 "EDATAX CNT 1",
//                 "EDATAX MOV J1", //....
//                 "EDATAX END",
//                 "SAVE",
...
//                 "SLOTINIT",
//                 "RUNROS;1",
//                 "1;2;VALM_RUN(1);M", //this will return the execution status
//                });
//        const auto cmds_clear = std::vector<std::string>({"OPEN=", "CNTLON", "LOAD=ROS", "DELETE2", ";X", "SAVE"});
//
//        auto suc(true);
//
////        suc &= mc.execute_cmd("OPEN=");
////        suc &= mc.execute_cmd("CNTLON");
////
////        suc &= mc.execute_cmd("OVRD=5");
//
//
//        if (suc) {
//            ROS_INFO_STREAM("All commands has passed");
//        } else {
//            ROS_WARN_STREAM("Some of the commands does not returns QoK");
//        }
